    ...
    if (!_imageManager) {
        ...
        _imageManager.downloadImageSuccess = ^(UIImage *image, NSInteger imageIndex) {
            ...
            if (weakSelf.currentIndex == imageIndex) {
                ...
                weakSelf.currentImageView.contentMode=UIViewContentModeScaleAspectFit;
                NSInteger height1 = weakSelf.currentImageView.image.size.height;
                NSInteger width1 = weakSelf.currentImageView.image.size.width;
                if (width1<=100 || height1<=100)
                {
                    weakSelf.currentImageView.contentMode=UIViewContentModeCenter;
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if ([self.images[_nextIndex] isKindOfClass:[NSNull class]]) {
        ...
        _nextImageView.contentMode=UIViewContentModeScaleAspectFit;
        NSInteger height1 = _nextImageView.image.size.height;
        NSInteger width1 = _nextImageView.image.size.width;
        if (width1<=100 || height1<=100)
        {
...
- (void)updateContent {
    ...
    _currentImageView.contentMode = UIViewContentModeScaleAspectFit;
     _nextImageView.contentMode = UIViewContentModeScaleAspectFit;
    NSInteger height1 = _currentImageView.image.size.height;
    NSInteger width1 = _currentImageView.image.size.width;
    if (width1<=100 || height1<=100)
    {
        _currentImageView.contentMode=UIViewContentModeCenter;
         _nextImageView.contentMode = UIViewContentModeScaleAspectFit;
