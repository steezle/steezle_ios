...
- (void)loadSearchView{
    ...
    UIView *topview=[[UIView alloc]initWithFrame:CGRectMake(0, 0, self.frame.size.width, 22)];
    topview.backgroundColor=[UIColor whiteColor];
    [self addSubview:topview];
    UITableView * tableView=[[UITableView alloc]initWithFrame:CGRectMake(0, topview.frame.size.height, SELFWIDTH, SELFHEIGHT) style:UITableViewStyleGrouped];
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section{
    ...
    [btn setTitle:@"Recent Search" forState:UIControlStateNormal];
